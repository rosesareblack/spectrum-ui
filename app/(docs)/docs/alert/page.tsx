  ...
  return (
    <div>
      <PageTemplate title="Animated Alert" className="mt-5">
        <PreviewCodeCard path="app/(docs)/docs/alert/alertdemo.tsx" cli={`${baseurl}/r/alert-demo.json`}>
          <Alertdemo />
        </PreviewCodeCard>
        ...
        <Usage path="app/(docs)/docs/alert/usage/alertthree.tsx" cli={`${baseurl}/r/alert-2.json`} >
          <Alert02 />
        </Usage>
        <Usage path="app/(docs)/docs/alert/usage/alertthree.tsx" cli={`${baseurl}/r/alert-3.json`}>
          <Alert03 />
        </Usage>
        <Usage path="app/(docs)/docs/alert/usage/alertfour.tsx" cli={`${baseurl}/r/alert-4.json`}>
          <Alert04 />
        </Usage>
